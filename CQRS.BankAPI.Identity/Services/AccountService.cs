    ...
    public class AccountService : IAccountService
    {
        ...
        public async Task<Response<AuthenticationResponse>> AuthenticateAsync(AuthenticationRequest request, string IpAddress)
        {
            ...
            if (user == null)
            {
                ...
                throw new ApiException($"No se encontro el usuario con el correo {request.Email}");
            }
            var result = await _signInManager.PasswordSignInAsync(user.UserName, request.Password, false, false);
            if (!result.Succeeded)
            {
                throw new ApiException($"Las credenciales no son validas");
            }
            ...
            return new Response<AuthenticationResponse>(response, $" Usuario {user.UserName} autenticado con exito");
        }
        ...
        public async Task<Response<string>> RegisterAsync(RegisterRequest request, string origin)
        {
            ...
            if (userWithSameUserName != null)
            {
                ...
                throw new ApiException($"El usuario {request.UserName} ya esta registrado.");
            }
            ...
            if (userWithSameEmail != null)
            {
                ...
                throw new ApiException($"El correo {request.Email} ya esta registrado.");
            }
            ...
            return new Response<string>("Usuario registrado con exito");
